...
export default function ServicesSection() {
  ...
  return (
    <section className="relative w-full bg-[#f8fafc] py-10 sm:py-12 font-sans select-none overflow-hidden text-[#0f172a]">
      ...
      >
            ...
            >
              ...
              {(activeTab === "All" || activeTab === "Registration") && (
                <motion.div layout className="lg:col-span-6 flex">
                  <Link
                    href="/services"
                    className="group w-full relative flex flex-col justify-between rounded-lg bg-white border border-slate-100 p-4 sm:p-6 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden"
                  >
                    <div className="flex flex-col sm:grid sm:grid-cols-12 gap-4 h-full">
                      ...
                      {/* Image Container */}
                      <div className="sm:col-span-5 relative h-36 sm:h-full min-h-[130px] w-full bg-slate-50/80 rounded-lg flex items-center justify-center p-3 order-2 sm:order-2">
                        <Image
              ...
              {(activeTab === "All" || activeTab === "Finance") && (
                <motion.div layout className="lg:col-span-3 flex">
                  <Link
                    href="/services"
                    className="group w-full relative flex flex-col justify-between rounded-lg bg-white border border-slate-100 p-4 sm:p-5 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden"
                  >
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                      ...
                      <div className="relative h-32 sm:h-28 w-full bg-slate-50/80 rounded-lg flex items-center justify-center mb-3 p-2">
                        <Image
                ...
                <motion.div layout className="flex">
                  ...
                  >
                    <div className="flex flex-col sm:grid sm:grid-cols-12 gap-3 items-center mb-3">
                      ...
                      <div className="w-full sm:col-span-6 h-32 sm:h-28 bg-slate-50/80 rounded-lg flex items-center justify-center p-2">
                        <Image
        ...
        <motion.div
          ...
          className="mt-8 sm:mt-10 rounded-lg bg-gradient-to-r from-[#fff2eb] via-[#fff8f5] to-white border border-[#f26522]/15 p-5 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-5 sm:gap-6 shadow-sm"
        >
          <div className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-3.5 sm:gap-4 w-full md:w-auto">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg bg-white shadow-sm border border-[#f26522]/20 flex items-center justify-center text-[#f26522] shrink-0">

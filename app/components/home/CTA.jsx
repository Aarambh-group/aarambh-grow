        ...
        <section className="relative w-full bg-[#f8fafc] py-6 sm:py-8 font-sans select-none overflow-hidden text-[#0f172a]">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <motion.div
                    ...
                    className="relative bg-white border border-slate-200/80 rounded-lg p-5 sm:p-6 lg:p-8 shadow-md shadow-slate-200/50 overflow-hidden"
                >
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="lg:col-span-5 flex flex-col justify-center">
                            <div className="bg-[#f8fafc] border border-slate-200/80 rounded-lg p-4 space-y-3 shadow-2xs">
                    ...
                    <motion.div
                        ...
                        whileInView="visible"
                        viewport={{ once: true, amount: 0.2 }}
                        className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-3 text-center pt-4 border-t border-slate-100"
                    >
                        <motion.div variants={itemVariants} className="bg-[#f8fafc] sm:bg-white border sm:border-slate-200/80 rounded-lg p-2.5 sm:p-3 shadow-2xs">

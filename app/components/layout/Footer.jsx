...
const socialLinks = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61592798116800",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/aarambhgrow/?hl=en",
    icon: (
      <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
  ...
  {
    label: "Meta",
    href: "https://business.facebook.com/latest?asset_id=1238662319334710&business_id=27909999175327293&ir_qe_exposed=1&nav_ref=mfb_get_started_header_cta",
    icon: (
      <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
        <path d="M23.95 12.7c-.15 2.3-1.15 4.3-2.8 5.75-1.8 1.55-4.25 2.3-6.9 2.15-2.45-.15-4.7-1.15-6.55-2.85C5.9 16 4.7 13.9 4.2 11.6c-.5-2.4-.1-4.8 1.15-6.9C6.6 2.6 8.7 1.35 11.1.9c2.5-.45 5.1.1 7.25 1.5 2.15 1.4 3.55 3.6 3.95 6.1.4 2.3.1 4.5-.35 6.55z" />
      </svg>
    ),
  },
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/143173930/admin/dashboard/",
    icon: (
      <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#081B33] text-slate-300 font-sans border-t-4 border-[#F97316] overflow-hidden">
      {/* Upper Executive Contact Bar */}
      <div className="border-b border-slate-800/80 bg-[#061528]/60 py-5">
        <motion.div

  ...
  const pillars = [
    {
      ...
      description: "Complete end-to-end entity incorporation and government filings designed to establish your corporate structure securely from day one.",
    ...
    },
    {
      ...
      description: "Robust accounting, financial forecasting, and CFO oversight aimed at preserving capital efficiency and driving enterprise value.",
    ...
    },
    {
      ...
      description: "Secure recognized quality approvals and government accreditation to clear vendor onboarding hurdles and build authority.",
    ...
    },
    {
      ...
      description: "Strategic communication kits, brand architecture, and digital presence tailored to help growing companies scale smoothly.",
    ...
    },
    {
      ...
      description: "Continuous corporate monitoring and legal risk mitigation to guard your enterprise against statutory delays and compliance lapses.",
    ...
    },
    {
      ...
      description: "Engineer internal operational workflows, implement institutional standard operating procedures (SOPs), and improve execution speed.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
          ...
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed max-w-xl mx-auto">
            Select a pillar to review the exact deliverables, legal frameworks, and strategic advantages we provide.
          </p>
        </div>
